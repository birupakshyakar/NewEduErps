            ...
            <div id="service-area">
                <div class="ptb-120">
                    <div class="container">
                        ...
                        <div class="row">
                            <?php 
                                $sql="select * from newslist where sub_category='breaking_news' id desc limit 4";
                                $result = mysqli_query($conn, $sql);
                                while($row=mysqli_fetch_array($result))
                                {
                                  
                                    /*echo "<div class='col-lg-2  col-md-2 col-sm-2' style='border: 1px solid black'>";
                                    echo "<img class='img-responsive img-thumbnail' src='".$row["image_path"]."' style='width:100% ! important; height:150px ! important'>";
                                    echo "<center><b>".$row['title']."</b></center>";
                                   echo "<hr class='hr' style='margin-top:0px ! important;margin-bottom:0px ! important'>
                                    <center><a class='test_class' data-toggle='collapse' href='#mp3_1' aria-expanded='true'><i class='fa fa-arrow-circle-down fa-2x faa-vertical animated' aria-hidden='true' style='color:black ! important'></i></a></center></div>";*/
                                    echo '<div class="col-6 col-lg-6 col-md-6 col-sm-12" style="height: 465px;padding: 0px 0px 5px 0px;">
