                            ...
                            <?php 
                                ...
                                for($i=1; $i<=$row_cnt; $i++)
                                {
                                  $row=mysqli_fetch_assoc($result);
                                    ...
                                    if($i==1){
                                        //echo $i;
                                        echo "<div class='col-6 col-lg-6 col-md-6 col-sm-12 pointerDiv' onclick='openNewsDetails(".$row['id'].")' style='height: 465px;padding: 0px 0px 5px 0px;'>
                                            ...
                                            if($i==2)
                                            {
                                                echo "<div class='col-6 col-lg-6 col-md-6 col-sm-12' style='height: 465px;padding: 0px;'>";
                                                echo "
                                                        <div class='col-12 col-lg-12 col-md-12 col-sm-12 pointerDiv' onclick='openNewsDetails(".$row['id'].")' style='height: 240px;padding: 0px 0px 5px 5px;'>
                                                            <img src='".$row["image"]."'' style='height: 100%;width: 100%'>
                                                            <div style='margin-top:-105px;background-color: black'>
                                                                <span style='background: black;color: white;padding: 5px;margin-left: 5px;'>".$row["category"]."</span>
                                                                <h4 style='color: white;margin-top: 12px;margin-left: 5px;'>".$row["heading"]." </h4>
                                        ...
                                        if($i==3)
                                        {
                                            echo '<div class="col-6 col-lg-6 col-md-6 col-sm-12 pointerDiv " onclick="openNewsDetails('.$row["id"].')" style="height: 220px;/* width: 49%; *//* margin-right: 4px; */padding: 0px 0px 0px 5px;">
                                                    <img src="'.$row["image"].'" style="height: 100%;width: 100%">
                                                    <div style="margin-top:-105px;background-color: black">
                                                        <span style="background: black;color: white;padding: 5px;margin-left: 5px;">'.$row["category"].'</span>
                                                        <h4 style="color: white;margin-top: 12px;margin-left: 5px;">'.$row["heading"].' </h4>
                                        ...
                                        if($i==4)
                                        {
                                           echo '<div class="col-6 col-lg-6 col-md-6 col-sm-12 pointerDiv " onclick="openNewsDetails('.$row["id"].')" style="height: 220px;/* width: 49%; *//* margin-left: 4px; */padding: 0px 0px 0px 5px;">
                                                    <img src="'.$row["image"].'" style="height: 100%;width: 100%">
                                                    <div style="margin-top:-105px;background-color: black">
                                                        <span style="background: black;color: white;padding: 5px;margin-left: 5px;">'.$row["category"].'</span>
                                                        <h4 style="color: white;margin-top: 12px;margin-left: 5px;">'.$row["heading"].' </h4>
                             ...
                             <?php 
                               ...
                               // echo $row_cnt;
                                while ( $row=mysqli_fetch_array($result)) {
                                    # code...
                                    //$p_value=wordwrap($row["content"],15,"<br>",true);
                                    $offset = (strlen($row["content"]))/4;
                                    $shortdesc = substr($row["content"], 0,strpos($row["content"], ' ', $offset)).'....';
                                    /*echo "test text are ".$shortdesc;*/
                                    echo '<div class="col-lg-4 col-md-4 col-sm-12 pointerDiv " onclick="openNewsDetails('.$row["id"].')">
                            ...
                            <?php 
                               ...
                               // echo $row_cnt;
                                while ( $row=mysqli_fetch_array($result)) {
                                        ...
                                        echo '<div class="col-lg-4 col-md-4 col-sm-12 mt-10 pointerDiv " onclick="openNewsDetails('.$row["id"].')" style="padding: 0px">
                            ...
                            <?php 
                               ...
                               // echo $row_cnt;
                                while ( $row=mysqli_fetch_array($result)) {
                                        ...
                                        echo '<div class="col-lg-2 col-md-3 col-sm-6 pointerDiv " onclick="openNewsDetails('.$row["id"].')">
                                                    <img src="'.$row["image"].'" style="height: 150px;width: 100%">                                
                                                    <h4>'.$row["heading"].'</h4>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12" style="padding: 0px 0px 0px 0px">
                                <h3 style="border-bottom: 4px solid tomato;color: white;"><span style="background-color: tomato;font-size: 22px;">ଅପରାଧ</span></h3>
                                 <?php 
                                   ...
                                   // echo $row_cnt;
                                    $row=mysqli_fetch_assoc($result);
                                    $shortdesc = substr($row["content"], 0,strpos($row["content"], ' ', 150)).'....'; 
                                    echo '<div class="col-lg-6 col-md-6 col-sm-12 pointerDiv " onclick="openNewsDetails('.$row["id"].')">
                                            <img src="'.$row["image"].'" style="height: 180px;width: 100%"> 
                                            <h3>'.$row["heading"].'</h3>
                                            <h6><b>'.$row["date"].'</b></h6>
                                            <p>'.$shortdesc.'</p>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <?php
                                       ...
                                       // echo $row_cnt;
                                        ...
                                        {
                                            echo '<div class="row pointerDiv " onclick="openNewsDetails('.$row["id"].')" style="margin-top: 10px">
